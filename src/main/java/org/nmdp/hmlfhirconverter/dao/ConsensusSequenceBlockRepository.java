...
public interface ConsensusSequenceBlockRepository extends MongoRepository<ConsensusSequenceBlock, String> {
    Page<ConsensusSequenceBlock> findAll(Pageable pageable);
}
