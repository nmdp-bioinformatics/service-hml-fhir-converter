...
public class SequenceController implements SequenceApi {
    ...
    public Callable<ResponseEntity<Boolean>> deleteSequence(@RequestBody Sequence sequence) throws NotFoundException {
        try {
            return () -> new ResponseEntity<>(sequenceService.deleteItem(sequence), HttpStatus.OK);
        } catch (Exception ex) {
    ...
    public Callable<ResponseEntity<Boolean>> deleteSequence(@PathVariable String id) throws NotFoundException {
        try {
            return () -> new ResponseEntity<>(sequenceService.deleteItem(id), HttpStatus.OK);
        } catch (Exception ex) {
    ...
    public Callable<ResponseEntity<Sequence>> getModel() {
        try {
            ...
            return () -> new ResponseEntity<>(new Sequence(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
