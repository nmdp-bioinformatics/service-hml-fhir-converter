 ...
 * HmlFieldConstants.java is a java class written by Enoch Kan to store constants
 * called in HmlXmlDeserializer.java.  Please refer to HMLGraph_reference.gif for schemas
